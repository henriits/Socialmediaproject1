...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('messaging', '0002_rename_timestamp_message_created_at'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='thread',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='messaging.threadmodel'),
        ),
    ]
